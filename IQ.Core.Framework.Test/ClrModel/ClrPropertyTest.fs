...
module ClrPropertyTest =
    ...
    let ``Created property descriptions from record``() =
        ...
        let p1Expect = {
            ClrPropertyDescription.Name = p1Name
            Position = 0
    ...
    let ``Created property descriptions from class``() =
        ...
        let p2Expect = {
            ClrPropertyDescription.Name = p2Name
            Position = 1
            DeclaringType = typeof<ClassA>.FullName |> FullTypeName
            ValueType = typeof<int>.FullName |> FullTypeName
            IsOptional = false
        ...
        let p3Expect = {
            ClrPropertyDescription.Name = p3Name
            Position = 2
            DeclaringType = typeof<ClassA>.FullName |> FullTypeName
            ValueType = typeof<int64>.ValueType.FullName |> FullTypeName
            IsOptional = true
            CanWrite = false
            WriteAccess = None
            CanRead = true
