--Adapted from https://github.com/readyroll/generate-sql-merge

--Exampple: EXEC Core.pGenerateMerge @schema = 'Metadata', @table_name ='IntrinsicTypeMap'
CREATE PROC Core.pGenerateMerge
(
