merge into Core.StorageType as Dst using(values
	...
	(30, 'UInt8', 'A signed 8-bit integer'),
	(31, 'UInt16', 'A signed 16-bit integer'),
	(32, 'UInt32', 'A signed 32-bit integer'),
	(33, 'UInt64', 'A signed 64-bit integer'),
	...
	(54, 'AnsiTextMax', 'An arbitrarily long, variable-length block of ANSI text with'),
	
	(52, 'UnicodeTextFixed', 'A fixed-length block of Unicode text'),
	(53, 'UnicodeVariable', 'A variable-length block of Unicode text with some specified upper-bound'),
	(54, 'UnicodeTextMax', 'A arbitrarily long, variable-length block of Unicode text'),

	(60, 'DateTime32', 'A 32-bit date'),
	(61, 'DateTime32', 'A 64-bit date'),
	...
	(120, 'Table', 'A custom tabular data type'),
	(130, 'Object', 'A custom CLR type')
